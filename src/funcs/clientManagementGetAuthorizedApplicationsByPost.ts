 ...
 */
export function clientManagementGetAuthorizedApplicationsByPost(
  client: AuthleteCore,
  request: operations.ClientAuthorizationGetListApiPostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ClientAuthorizationGetListApiPostResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  >(
    M.json(
      200,
      operations.ClientAuthorizationGetListApiPostResponse$inboundSchema,
      { key: "Result" },
    ),
