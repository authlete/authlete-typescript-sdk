...
> {
  const parsed = safeParse(
    request,
    (value) => models.ServiceCreateIdpRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ServiceCreateIdpApiServerList[ServiceCreateIdpApiServerIdp], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/api/service")();
