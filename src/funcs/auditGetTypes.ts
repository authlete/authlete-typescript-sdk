...
import {
  AuditTypesGetIdpApiServerIdp,
  AuditTypesGetIdpApiServerList,
} from "../models/operations/audittypesgetidpapi.js";
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(AuditTypesGetIdpApiServerList[AuditTypesGetIdpApiServerIdp], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/api/audit/types")();
